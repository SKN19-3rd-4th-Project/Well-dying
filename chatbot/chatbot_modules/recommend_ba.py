...
_PKG_DIR = _HERE.parent  # chatbot/chatbot_modules
_ROOT_DIR = _HERE.parents[2]  # 리포지토리 루트
RULE_CANDIDATES = [
    _PKG_DIR / "data" / "conversation_rules.json",  # (없을 가능성 있음)
    _PKG_DIR / "../data/processed/conversation_rules.json",
    _PKG_DIR / "../data/conversation_rules.json",
    _ROOT_DIR / "data" / "conversation_rules.json",  # 루트/data 기본 경로
]
